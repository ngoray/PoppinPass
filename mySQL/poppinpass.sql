...
INSERT INTO `cinemaroom` VALUES (7,'F1','Suspended'),(9,'Room1','Suspended'),(10,'Room2','active'),(11,'g1','active'),(12,'uu','active');
...
INSERT INTO `movieticket` VALUES (2,'Senior Citizen','65 and Above','$7'),(3,'Adult','21 above','$14'),(4,'Children','12 Below','$7'),(5,'Handicaps','Nonehj','$8');
...
INSERT INTO `occupancy` VALUES (1,'A1','A'),(2,'A2','A'),(3,'A3','A'),(4,'A4','A'),(5,'A5','A'),(6,'B1','B'),(7,'B2','B'),(8,'B3','B'),(9,'B4','B'),(10,'B5','B'),(11,'C1','C'),(12,'C2','C'),(13,'C3','C'),(14,'C4','C'),(15,'C5','C'),(16,'D1','D'),(17,'D2','D'),(18,'D3','D'),(19,'D4','D'),(20,'D5','D'),(21,'E1','E'),(22,'E2','E'),(23,'E3','E'),(24,'E4','E'),(25,'E5','E'),(26,'F2f','F'),(28,'g','g');
...
INSERT INTO `reviews` VALUES (5,'Ray','a@a.com',1,'i aSDFGHLKHDSJKDHQWKEJCND ASK'),(6,'Tam','Tam@tam.com',1,'I LOVE DADDY SIONGGO'),(7,'Shing','s@s.com',1,'qwerth'),(20,'your mum','YOUR MUM\'S EMAIL',3,'BEST MUM SERVICE EVER'),(21,'CD','SDBB',1,'`1SADFDVCBN'),(22,'Zsd','xcv',1,'asdcv'),(23,'THIS SHING KNN','sfdlkh',1,'sal;dfk;lskvc;l');
...
INSERT INTO `screentime` VALUES (12,'Monday','3pm','g1','Battle Of The Sexes'),(14,'Tuesday','5pm','uu','Sing '),(15,'Wednesday','3pm','uu','Battle Of The Sexes'),(16,'Saturday','9pm','F1','Red Sparrow ');
...
CREATE TABLE `seatmap` (
  ...
  CONSTRAINT `roomnumber` FOREIGN KEY (`roomnumber`) REFERENCES `cinemaroom` (`roomnumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `row` FOREIGN KEY (`row`) REFERENCES `occupancy` (`row`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `seat` FOREIGN KEY (`seatno`) REFERENCES `occupancy` (`seatno`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `seatmap` VALUES (173,'A1','A','Room1','active'),(175,'C1','C','Room1','Booked'),(177,'E1','E','Room1','Booked'),(178,'E2','E','Room1','Booked'),(179,'D2','D','Room1','active'),(180,'C2','C','Room1','Booked'),(181,'B2','B','Room1','active'),(182,'A2','A','Room1','active'),(183,'A3','A','Room1','active'),(184,'B3','B','Room1','active'),(185,'C3','C','Room1','Booked'),(186,'D3','D','Room1','active'),(188,'E4','E','Room1','Booked'),(189,'D4','D','Room1','active'),(190,'C4','C','Room1','Booked'),(191,'B4','B','Room1','active'),(192,'A4','A','Room1','active'),(193,'A5','A','Room1','active'),(194,'B5','B','Room1','active'),(195,'C5','C','Room1','active'),(196,'D5','D','Room1','active'),(198,'E3','E','Room1','Booked'),(199,'A3','A','F1','active'),(200,'A1','A','Room2','active'),(201,'E3','E','F1','active'),(202,'A5','A','F1','active'),(203,'A1','A','F1','active');
...
CREATE TABLE `transactionhistory` (
  ...
  `date` date NOT NULL,
  `quantityoftickets` int NOT NULL,
  PRIMARY KEY (`_id`),
...
INSERT INTO `transactionhistory` VALUES (2,'c','movietitle','tickettype','screentime','roomno','seatno','foodname','totalprice','2023-05-15',1),(3,'c','Battle Of The Sexes','Senior Citizen','3pm,3pm','Room1',' E1','Nacho Cheese','FREE (points redeemed)','2023-05-15',1),(4,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1',' E4','Popcorn','FREE (points redeemed)','2023-05-15',1),(5,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1','E5','v','233','2023-05-14',1),(6,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1','E2','233','233','2023-04-29',5),(8,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1','D2','25','244','2023-04-29',1),(9,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1','D2','25','244','2023-03-02',1),(10,'c','Battle Of The Sexes','Senior Citizen','Monday,3pm','Room1','D2','25','244','2023-05-03',1);
...
INSERT INTO `useraccount` VALUES (1,'a','a@a.aa','a','User Admin','active',0),(4,'b','b','b','Cinema Manager','active',0),(5,'c','cbbbb','c','Customer','active',115),(6,'d','d','d','User Admin','active',0),(7,'e','e','e','Customer','active',0),(8,'x','x','x','Cinema Owner','active',0),(9,'cc','cc','cc','Cinema Owner','active',100),(10,'ssss','sssss','sssss','Customer','active',100),(11,'abc','abc@gmail.comu','@@bc','User Admin','active',15),(12,'u','u','u','User Admin','active',100),(14,'q','q','q','Customer','active',100),(15,'gg','gg','gg','Customer','active',100),(16,'hi','hi','hi','Customer','active',100),(17,'pp','pp','pp','User Admin','active',100);
...
INSERT INTO `userprofile` VALUES (2,'User Admin','Manage Accounts'),(3,'Cinema Manager','Handles Ticketing, Movies, Seat allocation etc...'),(4,'Customer','Purchasing Movie Ticket, Beverages & Food and Giving Reviews etc..'),(5,'Cinema Owner','Generating Report'),(7,'ab','ac'),(8,'fuck','youEWRDHG');
...
-- Dump completed on 2023-05-18 10:14:11
